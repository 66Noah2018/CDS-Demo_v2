...
function payload(data) {
    ...
    if (plateletCountNormal(PARSED_DATA.latest_platelet_count) == -1 && NSAIDS.includes(PARSED_DATA.concept_id)) {
        return { cards: [getCard(PARSED_DATA.latest_platelet_count)] };
    } else return { cards: [] };
}
